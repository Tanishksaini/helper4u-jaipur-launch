				...
				<div className="grid lg:grid-cols-2 gap-12 items-center max-w-6xl mx-auto">
					...
					>
						...
						<p className="text-lg text-muted-foreground mb-4 leading-relaxed">
							Helperr4U is India's upcoming{" "}
							<strong className="text-foreground">
								verified Helper marketplace
							</strong>{" "}
							that connects people who need daily help with those looking for work
							— instantly and safely.
						</p>
						<p className="text-lg text-muted-foreground mb-4 leading-relaxed">
							Whether you need a{" "}
							<strong className="text-foreground">maid for 2 hours</strong>, a{" "}
							<strong className="text-foreground">driver for 1 trip</strong>, or a{" "}
							<strong className="text-foreground">salesman for your shop</strong> —
							Helper4U makes it simple, safe, and local.
						</p>
						<p className="text-lg text-muted-foreground mb-6 leading-relaxed">
							We're starting our journey in{" "}
							<strong className="text-primary">Jaipur</strong> soon, bringing a
							much-needed solution to families, shop owners, and Helpers across the
							city.
						</p>
